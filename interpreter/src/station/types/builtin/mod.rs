...
lazy_static! {
    /// A manifest of all built in stations
    pub static ref BUILTIN_STATION_TYPES: Vec<&'static BuiltinStationType> = vec![
        &control::START,
        &control::EXIT,
        &control::JOINT,
        &control::ASSIGN,
